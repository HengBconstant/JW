					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									<li class="current"><a class="" href="flot_charts.html"><span class="sub-menu-text">Flot Charts</span></a></li>
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-signal"></i>Basic Chart</h4>
										<div class="tools">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border purple">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o"></i>Tracking curve</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-6">
								...
								<div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-signal"></i>Auto Updating Chart</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-6">
								<!-- STACKED BARS & LINES CHART -->
								<div class="box border red">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o"></i>Stacked Bars & Lines Chart</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body clearfix">
										...
										<div class="btn-toolbar pull-right">
											<div class="btn-group graphControls">
											   ...
											   <input type="button" class="btn btn-primary" value="Lines with steps" />
											</div>
										 </div>
									</div>
								</div>
							...
							<div class="col-md-6">
								<!-- HORIZONTAL BAR CURVE -->
								<div class="box border green">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o"></i>Horizontal Bar chart</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border inverse">
									<div class="box-title">
										<h4><i class="fa fa-adjust"></i>Default Legend Pie Chart</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-6">
								...
								<div class="box border inverse">
									<div class="box-title">
										<h4><i class="fa fa-adjust"></i>Donut Pie Chart</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<h5>Pie that looks like a donut</h5>
