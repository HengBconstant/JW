						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="invoice.html"><span class="sub-menu-text">Invoice</span></a></li>
										  ...
										  <div class="panel-body">
												...
												<div class='col-md-12'>
													<div class="invoice-header clearfix">
														<h3 class='pull-left'>
														  ...
														  <span>Invoice</span>
														  <span class='text-muted'>#A3425</span>
														</h3>
														<div class='pull-right'>
														  <div class='btn-group'>
															<a class="btn btn-default" href="#"><i class='fa fa-external-link'></i>
															Export
															</a>
															<a class="btn btn-success" href="#"><i class='fa fa-check'></i>
															Paid
															</a>
														  </div>
														</div>
											...
											<div class='row'>
												<div class='col-sm-4 seller'>
												  <div class='invoice-title'>Debit</div>
												  <i class='fa fa-female'></i>
												  <address>
													<strong>Red John</strong>
													<br>
													...
													USA
													<br>
													<small><a href="mailto:john@doe.com">redjohn@gmail.com</a></small>
													<br>
													<small>(123) 456-7890</small>
												  </address>
												</div>
												<div class='col-sm-4 buyer'>
												  <div class='invoice-title'>Credit</div>
												  <i class='fa fa-male'></i>
												  <address>
													<strong>Patrick Jane</strong>
													<br>
													...
													USA
													<br>
													<small><a href="mailto:jane@doe.com">jane@yahoo.com</a></small>
													<br>
												...
												<div class='col-sm-4 payment-info'>
												  ...
												  <div class="well">
													  <strong>Invoice date: </strong> 18/10/2013
													  <br>
													  <strong>Billing period: </strong> 16/09/2013 to 17/10/2013
													  <br>
													  <strong>Bank account: </strong> 123 456 789 101
													  <br>
													  <strong>SWIFT Code: </strong> 153462792SHFD
													  <br>
										  ...
										  <table class="table table-striped table-hover font-400 font-14">
											...
											<tbody>
											  <tr>
												...
												<td>
												  <div class='text-right hidden-xs'>$129.00</div>
												</td>
												<td>
												  <div class='text-right'>$129.00</div>
												</td>
											  </tr>
											  <tr>
												<td>C734</td>
												...
												<td>
												  <div class='text-right hidden-xs'>$203.00</div>
												</td>
												<td>
												  <div class='text-right'>$842.00</div>
												</td>
											  </tr>
											  <tr>
												<td>C634</td>
												...
												<td>
												  <div class='text-right hidden-xs'>$505.00</div>
												</td>
												<td>
												  <div class='text-right'>$505.00</div>
												</td>
											  </tr>
											  <tr>
												<td>CO57</td>
												...
												<td>
												  <div class='text-right hidden-xs'>$354.00</div>
												</td>
												<td>
												  <div class='text-right'>$716.00</div>
												</td>
											  </tr>
											  <tr>
												<td>C237</td>
												<td>Devices & Safety Switches</td>
												<td>
												  <div class='text-center'>2</div>
												</td>
												<td>
												  <div class='text-right hidden-xs'>$198.00</div>
												</td>
												<td>
												  <div class='text-right'>$396.00</div>
												</td>
											  </tr>
											  <tr>
												<td>C124</td>
												...
												<td>
												  <div class='text-right hidden-xs'>$713.00</div>
												</td>
												<td>
												  <div class='text-right'>$713.00</div>
												</td>
											  </tr>
											</tbody>
										  </table>
