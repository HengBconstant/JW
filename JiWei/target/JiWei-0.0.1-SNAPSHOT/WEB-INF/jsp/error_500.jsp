						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="error_500.html"><span class="sub-menu-text">Error 500 Option 1</span></a></li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Error 500</h3>
									</div>
									<div class="description">Error 500 Page</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
