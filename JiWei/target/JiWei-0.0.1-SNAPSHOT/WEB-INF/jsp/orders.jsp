...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Orders</title>
...
<body>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="orders.html"><span class="sub-menu-text">Orders</span></a></li>
								</ul>
							</li>
							<li class="has-sub">
								<a href="javascript:;" class="">
												...
												<div class="panel panel-default">
												  <div class="panel-body">
													...
													<div class="pull-right hidden-xs">
														<div class="btn-group">
															<button class="btn btn-default"><i class="fa fa-bars"></i> Fullfill order</button>
															<button class="btn btn-success"><i class="fa fa-check"></i> Mark as complete</button>
														</div>
													</div>
													...
													<table class='table table-hover'>
													  ...
													  <tbody>
														<tr>
														  ...
														  <td>
															<div class='text-right'>$999.00</div>
														  </td>
														</tr>
														<tr>
														  <td class='only-checkbox'>
														  ...
														  <td>
															<div class='text-right'>$299.00</div>
														  </td>
														</tr>
														<tr>
														  <td class='only-checkbox'>
													...
													<div class="row">
														<div class="col-sm-4">
															...
															<h5><strong><span class="label label-success"><i class="fa fa-check"></i> PAID</span></strong></h5><br>
															<h4>
																<i class="fa fa-dollar"></i>
																Payment Method
															</h4>
															<h5><strong><span class="label label-primary"><i class="fa fa-check"></i> CREDIT CARD</span></strong></h5><br>
														</div>
														<div class="col-sm-7 col-sm-offset-1">
															...
															<div class="well">	
																<h5><strong>Joyce R. Duke</strong></h5><br>
																2849 Harry Place<br>
													...
													<div class="form-actions form-actions-padding">
														<ul class="pager">
															<li class="previous">
																<a href="#" class="btn btn-default"><i class="fa fa-chevron-left fa-2x"></i></a>
															</li>
															<li class="next">
																<a href="#" class="btn btn-default"><i class="fa fa-chevron-right fa-2x"></i></a>														
															</li>
														</ul>
													</div>
												  </div>
	...
	<script>
		jQuery(document).ready(function() {		
			App.setPage("orders");  //Set current page
