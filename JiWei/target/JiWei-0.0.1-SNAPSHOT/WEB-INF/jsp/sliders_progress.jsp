...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Sliders & Progress</title>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="sliders_progress.html"><span class="sub-menu-text">Sliders & Progress</span></a></li>
					...
					<div id="content" class="col-lg-12">
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li>Sliders & Progress</li>
									</ul>
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Sliders & Progress Bars</h3>
									</div>
									<div class="description">Sliders, Progress Bars, Circle Dials and Carousel</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border inverse">
									<div class="box-title">
										<h4><i class="fa fa-arrows-h"></i>Sliders</h4>
										<div class="tools">
									...
									<div class="box-body">
										<div class="form-horizontal ">
											<div class="form-group">         
											 <label class="col-md-2 col-md-2 control-label">
											   Default:
											 </label>											 
											 <div class="col-md-10">
											    <div id="slider-default" class="slider">
											    </div>
											 </div>											 
										   </div>
										   <div class="form-group">         
											 ...
											 <div class="col-md-10">
											    <div id="slider" class="slider slider-yellow">
											    </div>
											 </div>											 
										   </div>
											<div class="form-group">
											   ...
											   <div class="col-md-10">
												  <div id="slider-vertical-multiple" class="slider-eq">
													 ...
													 <span class="slider slider-yellow">
													 90
													 </span>
													 <span class="slider slider-yellow">
													 20
													 </span>
													 <span class="slider slider-red">
													 60
													 </span>
													 <span class="slider slider-red">
													 40
													 ...
													 <span class="slider slider-green">
													 49
													 </span>
													 <span class="slider slider-green">
													 85
											...
											<div class="form-group">
											   ...
											   <div class="col-md-10">
												  <div id="slider-range-min" class="slider slider-blue">
												  </div>
											   </div>
											</div>
											<div class="form-group">
											   ...
											   <div class="col-md-10">
												  <div id="slider-range-max" class="slider slider-yellow">
												  </div>
											   </div>
											</div>
											<div class="form-group">
											   ...
											   <div class="col-md-10">
												  <div id="slider-horizontal-range-min" class="slider slider-green">
												  </div>
											   </div>
											</div>
											<div class="form-group">
											   ...
											   <div class="col-md-10">
												  <div id="slider-vertical-range-min" class="slider slider-green">
												  </div>
											   </div>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border primary">
									<div class="box-title">
										<h4><i class="fa fa-long-arrow-right"></i>Progress Bars</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
										...
										<div class="form-horizontal ">
											<div class="form-group">
												...
												<div class="col-md-10">
													<div id="progress1">
														...
														<div class="pbar progress progress-green"></div>
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<div id="progress2">
														<div class="percent"></div>
														<div class="pbar progress progress-yellow"></div>
														<div class="elapsed"></div>
													</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-10">
													<div id="progress3">
														<div class="percent"></div>
														<div class="pbar progress progress-red"></div>
														<div class="elapsed"></div>
													</div>
												</div>
											</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border purple">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Progress Bars</h4>
									...
									<div class="box-body">
										...
										<div class="progress">
										  <div class="progress-bar progress-bar-pink" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100" style="width: 55%">
										  </div>
										</div>
										<div class="progress">
										...
										<div class="progress">
										  <div class="progress-bar progress-bar-pink" style="width: 25%">
											<span class="sr-only">35% Complete (success)</span>
										  </div>
										  <div class="progress-bar progress-bar-blue" style="width: 50%">
											<span class="sr-only">20% Complete (warning)</span>
										  </div>
										  <div class="progress-bar progress-bar-yellow" style="width: 15%">
											<span class="sr-only">10% Complete (danger)</span>
										  </div>
										</div>
										<h4>Striped</h4>
										<div class="progress progress-striped">
										  <div class="progress-bar progress-bar-dark" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">
										...
										<div class="progress progress-striped active">
										  <div class="progress-bar progress-bar-dark"  role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 25%">
											<span class="sr-only">45% Complete</span>
										  </div>
										</div>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border pink">
									<div class="box-title">
										<h4><i class="fa fa-adjust"></i>Circle Dials</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body center">
										<div class="row">
										  ...
										  <div class="col-md-4">
											 ...
											 <input class="knob" data-width="150" data-cursor="true" data-fgColor="#8fc556" data-thickness=".3" value="29">
										  </div>
										  <div class="col-md-4">
											 <h5>
									   ...
									   <div class="row">
										  ...
										  <div class="col-md-4">
											 ...
											 <input class="knob" data-angleOffset="-125" data-angleArc="250" data-fgColor="#D9534F" value="35">
										  </div>
										  <div class="col-md-4">
											 <h5>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box solid grey">
									<div class="box-title">
										<h4><i class="fa fa-dot-circle-o"></i>Circle Dials Tron Theme</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body center">
										<div class="row">
										  <div class="col-md-4">
											 ...
											 <input class="knob" data-width="120" data-displayPrevious=true data-fgColor="#ffec03" data-skin="tron" data-cursor=true value="75" data-thickness=".2">
										  </div>
										  <div class="col-md-4">
											 <h5>
												Cursor Mode
											 </h5>
											 <input class="knob" data-width="150" data-displayPrevious=true data-fgColor="#8fc556" data-skin="tron" data-thickness=".2" value="75">
										  </div>
										  <div class="col-md-4">
											 <h5>
												Display previous value
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-picture-o"></i>Carousel</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
