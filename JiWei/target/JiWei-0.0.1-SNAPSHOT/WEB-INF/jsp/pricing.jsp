...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Pricing</title>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="pricing.html"><span class="sub-menu-text">Pricing</span></a></li>
					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Pricing</h3>
									</div>
									<div class="description">Pricing Tables</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Pricing Table 1</h4>
										<div class="tools">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Pricing Table 2</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										...
										<ul class="pricing_table row">
											<li class="price_block_static col-md-4 col-xs-11">
												<h3>Silver</h3>
												<div class="price">
													<div class="price_figure">
														<span class="price_number">$9.99</span>
											...
											<li class="price_block_static active col-md-4 col-xs-11">
												<h3>Gold</h3>
												<div class="price">
													<div class="price_figure">
														<span class="price_number">$19.99</span>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Pricing Table 3</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
