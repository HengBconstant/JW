...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Rich Text Editors</title>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="rich_text_editors.html"><span class="sub-menu-text">Rich Text Editors</span></a></li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Rich Text Editors</h3>
									</div>
									<div class="description">Bootstrap and CK Editors</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border green">
									<div class="box-title">
										<h4><i class="fa fa-pencil-square-o"></i>Bootstrap Editor with Keyboard Shortcuts</h4>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-pencil-square"></i>Advanced Editor (CKEditor)</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border red">
									<div class="box-title">
										<h4><i class="fa fa-pencil-square"></i>Bootstrap Markdown Editor</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
