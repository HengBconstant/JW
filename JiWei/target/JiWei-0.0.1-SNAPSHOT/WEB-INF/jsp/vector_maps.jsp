...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Vector Maps</title>
	...
	<!-- JQVMAPS -->
	<link rel="stylesheet" type="text/css" href="js/jqvmap/jqvmap.css" />
	<!-- FONTS -->
...
<body>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="vector_maps.html"><span class="sub-menu-text">Vector Maps</span></a></li>
								</ul>
							</li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Vector Maps</h3>
									</div>
									<div class="description">Vector Maps of the World, Continents, Countries etc.</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-globe"></i>World Map</h4>
										<div class="tools">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border red">
									<div class="box-title">
										<h4><i class="fa fa-compass"></i>Europe</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-6">
								...
								<div class="box border inverse">
									<div class="box-title">
										<h4><i class="fa fa-map-marker"></i>Russia</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border pink">
									<div class="box-title">
										<h4><i class="fa fa-map-marker"></i>Germany</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-6">
								...
								<div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-compass"></i>USA</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
    ...
    <script src="js/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
    <script src="js/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
    <script src="js/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
    <script src="js/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
    <script src="js/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
    <script src="js/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>  
	<!-- COOKIE -->
	...
	<script>
		jQuery(document).ready(function() {		
			App.setPage("vector_maps");  //Set current page
