...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Email Templates</title>
...
<body>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="email_templates.html"><span class="sub-menu-text">Email Templates</span></a></li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Email Templates</h3>
									</div>
									<div class="description">Email Templates with intuitive formats</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border red">
									<div class="box-title">
										<h4><i class="fa fa-envelope"></i>Email Templates Layout Options</h4>
									...
									<div class="box-body">
										<div class="alert alert-info">
											<p>These Email Blueprints include template language elements that make them customizable when imported into a MailChimp account, as well as merge tags that will generate dynamic content when sent through MailChimp.</p>
											<p>Not a MailChimp user? You can <a href="http://www.mailchimp.com/signup"><strong>sign up free</strong></a> or simply strip out merge tags and use these templates to send through any system.</p>
										</div>
										<ul id="email-layouts">
											<li><a href="email_templates/email_template_layout_1.html">Layout Option 1 - Customized</a></li>
											<li><a href="email_templates/email_template_layout_2.html">Layout Option 2 - Two Column</a></li>
											<li><a href="email_templates/email_template_layout_3.html">Layout Option 3 - Three Column</a></li>
											<li><a href="email_templates/email_template_layout_4.html">Layout Option 4 - Basic Two Column</a></li>
											<li><a href="email_templates/email_template_layout_5.html">Layout Option 5 - Basic Body Image</a></li>
											<li><a href="email_templates/email_template_layout_6.html">Layout Option 6 - Basic</a></li>
											<li><a href="email_templates/email_template_layout_7.html">Layout Option 7 - Body Image Two Column</a></li>
										</ul>
									</div>
								</div>
								<!-- /BOX -->
	...
	<script>
		jQuery(document).ready(function() {		
			App.setPage("email_template");  //Set current page
