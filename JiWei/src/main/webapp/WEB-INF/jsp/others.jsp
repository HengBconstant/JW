...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Other Charts</title>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="others.html"><span class="sub-menu-text">Others</span></a></li>
								</ul>
							</li>
							<li class="has-sub">
								<a href="javascript:;" class="">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Other Charts</h3>
									</div>
									<div class="description">Other Charts and Graphs</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border inverse">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Dynamic Pie Charts</h4>
										<div class="tools">
									...
									<div class="box-body">
										<div class="row">
											...
											<div class="col-md-3 text-center">
												<div id="pie_2" class="piechart padding-bottom-20" data-percent="72">
													<span class="percent"></span>
												</div>
											...
											<div class="col-md-3 text-center">
												<div id="pie_3" class="piechart padding-bottom-20" data-percent="55">
													<span class="percent"></span>
												</div>
											...
											<div class="col-md-3 text-center">
												<div id="pie_4" class="piechart padding-bottom-20" data-percent="28">
													<span class="percent"></span>
												</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border green">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Growing graph</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Sparklines Bars</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-4">
								...
								<div class="box border pink">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Sparklines Lines</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body big sparkline-stats">
										<div class="sparkline-row">
											...
											<span class="value">2765</span>
											<div class="linechart linechart-lg">1:3,2.7:4,3:3,4:3.4,5:6.5,6:2.3,7:5.4</div>
										</div>
										<div class="sparkline-row">
											<span class="title">Pageviews</span>
											<span class="value">21876</span>
											<div class="linechart linechart-lg">1:4.5,2.7:2,3:3,4:3.4,5:3.5,6:5.3,7:2.4</div>
										</div>
										<div class="sparkline-row">
											<span class="title">Bounce Rate</span>
											<span class="value">23%</span>
											<div class="linechart linechart-lg">1:3.9,2.5:4,3:1.2,4:6.4,5:4.5,6:3.7,7:3.4</div>
										</div>								
									</div>
								</div>
								<!-- /BOX -->
							...
							<div class="col-md-4">
								...
								<div class="box border primary">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Sparklines Pie</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Gauge Styles</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
