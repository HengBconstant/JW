...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Widgets & Box</title>
					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							...
							<li class="has-sub">
								...
								<ul class="sub">
									<li><a class="" href="forms.html"><span class="sub-menu-text">Form Elements</span></a></li>
					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Widgets & Box</h3>
									</div>
									<div class="description">Widget Boxes, Nested Boxes, Portlets, Draggable Portlets etc.</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-4 box-container">
								...
								<div class="box">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Box</h4>
										<div class="tools">
