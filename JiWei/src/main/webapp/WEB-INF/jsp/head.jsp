...
<body>
	...
	<section id="page">
		...
		<div id="main-content">
			...
			<div class="modal fade" id="add-head" tabindex="-1" role="dialog"
				aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<form class="form-horizontal" role="form" id="head">
							<div class="form-group">
								<label class="col-sm-3 control-label">负责人名称</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">负责人单位</label>
								<div class="col-sm-6">
									<input class="form-control" id="focusedInput" type="text"
										placeholder="负责人单位">
								</div>
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="head">负责人管理</a></li>
									</ul>
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">负责人管理</h3>
									</div>
									<div class="description">对负责人的crud</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border purple">
									<div class="box-title">
										<h4>
											<i class="fa fa-table"></i>负责人列表
										</h4>
										<div class="tools hidden-xs">
											<a href="#add-head" data-toggle="modal" class="config"
												title="添加负责人"> <i class="fa fa-plus"></i>
									...
									<div class="box-body">
										<table id="datatable2" cellpadding="0" cellspacing="0"
											...
											<thead>
												<tr>
													<th class="center hidden-xs">负责人名称</th>
													<th class="center hidden-xs">负责人单位</th>
													<th class="center hidden-xs">负责人联系方式</th>
											...
											<tbody>
												<tr class="gradeX">
													...
													<td class="center"><span class="label label-info" onclick="edithead(${id})">编辑</span>
														<span class="label label-danger" onclick="delhead(${id})">删除</span></td>
												</tr>
												<tr class="gradeX">
													<td class="center hidden-xs">Trident</td>
													<td class="center hidden-xs">Internet Explorer 4.0</td>
