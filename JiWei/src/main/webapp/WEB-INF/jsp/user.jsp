			...
			<div class="sidebar-menu nav-collapse">
				...
				<ul>
					<li><a href="index"> <i class="fa fa-tachometer fa-fw"></i>
							<span class="menu-text">Dashboard</span> <span class="selected"></span>
					</a></li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" role="form" id="user">
							...
							<div class="form-group">
								<label class="control-label col-md-3">用户密码<span
									class="required">*</span></label>
								<div class="col-md-6">
									<input type="password" class="form-control" name="password"
										id="password1" placeholder="用户密码" /> <span
										class="error-span"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="password" class="form-control" name="password1"
										id="password2" placeholder="确认密码" /> <span
										class="error-span"></span>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="building">用户管理</a></li>
									</ul>
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">用户管理</h3>
									</div>
									<div class="description">对用户的crud</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
								...
								<div class="box border purple">
									<div class="box-title">
										...
										<div class="tools hidden-xs">
											<a href="#add-user" data-toggle="modal" class="config"
												title="添加用户"> <i class="fa fa-plus"></i>
									...
									<div class="box-body">
										<table id="datatable2" cellpadding="0" cellspacing="0"
											...
											<thead>
												<tr>
													<th class="center hidden-xs">用户名称</th>
													<th class="center hidden-xs">工作单位</th>
													<th class="center hidden-xs">联系方式</th>
													<th class="center hidden-xs">用户角色</th>
											...
											<tbody>
												<tr class="gradeX">
													...
													<td class="center"><span class="label label-info"
														onclick="edituser(${id})">编辑</span> <span
														class="label label-danger" onclick="deluser(${id})">删除</span></td>
												</tr>
												<tr class="gradeX">
													<td class="center hidden-xs">Trident</td>
													<td class="center hidden-xs">Internet Explorer 4.0</td>
