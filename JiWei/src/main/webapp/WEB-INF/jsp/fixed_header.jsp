...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Fixed Header</title>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="fixed_header.html"><span class="sub-menu-text">Fixed Header</span></a></li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Fixed Header</h3>
									</div>
									<div class="description">Fixed Header Layout</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
