...
<body>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="xcharts.html"><span class="sub-menu-text">xCharts</span></a></li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">xCharts</h3>
									</div>
									<div class="description">Interactive and Dynamic xCharts</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
									...
									<div class="box-body">
										<div class="row">
											<div class="col-md-3 btn-group multi">
												<button class="btn btn-default toggled" data-type="line-dotted">Line</button>
												<button class="btn btn-default" data-type="cumulative">Cumulative</button>
												<button class="btn btn-default" data-type="bar">Bar</button>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-signal"></i>Time-Series Line</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-6">
								...
								<div class="box border inverse">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o"></i>Interacting With Points</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<figure class="chart" id="chart3" style="min-width:250px"></figure>
									</div>
								</div>
								<!-- /BOX -->
							</div>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="box border pink">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o"></i>Basic Bar Chart</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<figure class="chart" id="chart4" style="min-width:250px"></figure>
									</div>
								</div>
								<!-- /BOX -->
							</div>
							<div class="col-md-4">
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-signal"></i>Multi-Series Bar Chart</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<figure class="chart" id="chart5" style="min-width:250px"></figure>
									</div>
								</div>
								<!-- /BOX -->
							</div>
							<div class="col-md-4">
								...
								<div class="box border green">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o"></i>Custom Vis Type: Error Bars</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<figure class="chart" id="chart6" style="min-width:250px"></figure>
									</div>
								</div>
								<!-- /BOX -->
							</div>
	...
	<script>
		jQuery(document).ready(function() {		
			App.setPage("xcharts");  //Set current page
