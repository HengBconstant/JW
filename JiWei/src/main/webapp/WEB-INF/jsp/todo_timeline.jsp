...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Todo & Timeline</title>
	...
	<!-- MODERNIZR -->
	<script src="js/vertical-timeline/js/libs/modernizr-2.5.3.min.js"></script>	
	<!-- FONTS -->
...
<body>
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="todo_timeline.html"><span class="sub-menu-text">Todo & Timeline</span></a></li>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Todo List & Timeline</h3>
									</div>
									<div class="description">Todo List and Timeline</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
								...
								<div class="alert alert-block alert-info fade in">
									<a class="close" data-dismiss="alert" href="#" aria-hidden="true">&times;</a>
										<p><h4>How it works <i class="fa fa-arrow-right"></i></h4> 
										   1. Click on a todo to 'Mark as Complete'</p>
										<p>2. Add new tasks using the text box below</p>
										<p>3. New to-dos appear at the top.</p>
										<p>4. Items can be dragged and reordered.</p>
							...
							<div class="col-md-6">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Color Coded Todo List</h4>
									...
									<div class="box-body">
										<h4>To Do</h4>
										<ul id="toDoList">
											<li class="toDo">Hi there!</li>
											<li class="toDo">This is awesome little to-do app.</li>
											<li class="toDo">It’s small yet powerful.</li>
											<li class="toDo">But it can do a few nifty things.</li>
											<li class="toDo">Click on a to-do to complete it.</li>
											<li class="toDo">Add new ones using the text box below. Just hit 'Return'.</li>
											<li class="toDo">New to-dos appear at the top.</li>
											<li class="toDo">But you can drag items to reorder them.</li>
										</ul>
										<h4>Completed</h4>
										<ul id="completeList">
											<li class="youCompleteMe">This to-do has been completed. Click it to make it active again.</li>
										</ul>
										
										<form>
											<div class="input-group"> 
												<input type="text" id="newItem" placeholder="Add a new todo" class="form-control"> 
												<span class="input-group-btn"> <button id="addItem" class="btn btn-primary" type="button"><i class="fa fa-plus-circle"></i> Add Todo</button></span> 
											</div>
										</form>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Horizontal Timeline</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
	...
	<!-- TIMELINEJS -->
	<script type="text/javascript" src="js/timelinejs/js/storyjs-embed.min.js"></script>
	<!-- TODO -->
	...
	<script type="text/javascript" src="js/vertical-timeline/js/plugins.js"></script>
  ...
  <script id="post-template" type="text/x-handlebars-template">
	...
	<script>
		jQuery(document).ready(function() {		
			App.setPage("todo_timeline");  //Set current page
