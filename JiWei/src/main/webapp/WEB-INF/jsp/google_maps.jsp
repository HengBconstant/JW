...
<head>
	...
	<meta charset="utf-8">
	<title>Cloud Admin | Google Maps</title>
					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									<li class="current"><a class="" href="google_maps.html"><span class="sub-menu-text">Google Maps</span></a></li>
					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Google Maps</h3>
									</div>
									<div class="description">Google Maps and Street View</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border red">
									<div class="box-title">
										<h4><i class="fa fa-compass"></i>Basic</h4>
										<div class="tools">
							...
							<div class="col-md-6">
								...
								<div class="box border orange">
									<div class="box-title">
										<h4><i class="fa fa-map-marker"></i>Markers</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border green">
									<div class="box-title">
										<h4><i class="fa fa-globe"></i>Geolocation</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-6">
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-compass"></i>Polylines</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border inverse">
									<div class="box-title">
										<h4><i class="fa fa-map-marker"></i>Polygons</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
							...
							<div class="col-md-6">
								...
								<div class="box border pink">
									<div class="box-title">
										<h4><i class="fa fa-globe"></i>Static</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border green">
									<div class="box-title">
										<h4><i class="fa fa-compass"></i>Routes</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<form class="form-inline" action="#">
											<input type="button" id="gmap_routes_start" class="btn btn-primary" value="Start Routing" />
										 </form>
										 <div class="divide-20"></div>
							...
							<div class="col-md-6">
								...
								<div class="box border primary">
									<div class="box-title">
										<h4><i class="fa fa-map-marker"></i>Geocoding - Search</h4>
									...
									<div class="box-body">
										<form class="form-inline" action="#">
											<div class="input-group">
											   ...
											   <button class="btn btn-primary" id="gmap_geocoding_btn"><i class="fa fa-search"></i>
											   </span>
											</div>
										 </form>
										 <div class="divide-20"></div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box border purple">
									<div class="box-title">
										<h4><i class="fa fa-map-marker"></i>OpenStreet & CloudMade Maps</h4>
										<div class="tools hidden-xs">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<div id="gmap_types" class="gmaps"></div>
									</div>
								</div>
								<!-- /BOX -->
							</div>
							<div class="col-md-6">
								...
								<div class="box border">
									<div class="box-title">
										<h4><i class="fa fa-compass"></i>Google Streetview</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<div id="gmap_panaroma" class="gmaps"></div>
									</div>
								</div>
								<!-- /BOX -->
							</div>
