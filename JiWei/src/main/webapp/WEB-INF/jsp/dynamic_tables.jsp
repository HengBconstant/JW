						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="dynamic_tables.html"><span class="sub-menu-text">Dynamic Tables</span></a></li>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="box solid grey">
									<div class="box-title">
										<h4><i class="fa fa-bars"></i>Table in Modal</h4>
										<div class="tools">
											<a href="#box-config" data-toggle="modal" class="config">
												<i class="fa fa-cog"></i>
											</a>
									...
									<div class="box-body">
										<a href="#table-modal" data-toggle="modal" class="btn btn-primary">Click here to show table</a>
									</div>
								</div>
								<!-- /BOX -->
							</div>
