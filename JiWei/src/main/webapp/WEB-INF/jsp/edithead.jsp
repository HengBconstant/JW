							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="edithead">编辑负责人</a></li>
									</ul>
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">编辑负责人</h3>
									</div>
									<div class="description">编辑负责人信息</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
